...
CREATE TABLE `convocado` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_convocados_jugador1_idx` (`jugador_id`),
  KEY `fk_convocado_staff1_idx` (`staff_id`),
  CONSTRAINT `fk_convocados_jugador1` FOREIGN KEY (`jugador_id`) REFERENCES `jugador` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_convocado_staff1` FOREIGN KEY (`staff_id`) REFERENCES `staff` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
