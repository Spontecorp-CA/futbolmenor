...
CREATE TABLE `cronica` (
  ...
  `foto` longblob,
  `cronista_id` int(10) unsigned NOT NULL,
  `activa` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_cronica_cronista1_idx` (`cronista_id`),
  CONSTRAINT `fk_cronica_cronista1` FOREIGN KEY (`cronista_id`) REFERENCES `cronista` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2014-04-30 15:00:30
