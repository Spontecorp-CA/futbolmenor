...
public class FaseController implements Serializable {
    ...
    public String update() {
        try {
            //Listo todas las Fase de la Temporada
            List<Fase> allFases = getJpaController().findFasesOnTemporada(current.getTemporadaId());
            //Seteo las Jornadas como NO ACTUAL
            for(Fase fase : allFases){
                fase.setIsCurrent(0);
                getJpaController().edit(fase);
            }
